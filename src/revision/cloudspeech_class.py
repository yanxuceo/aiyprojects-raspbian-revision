...
from google.cloud.speech import StreamingRecognitionConfig, SpeechContext, RecognitionConfig
from google.oauth2 import service_account

from audio_class import AudioFormat, Recorder
...
class CloudSpeechClient:
    ...
    def _make_config(self, language_code, hint_phrases):
        return RecognitionConfig(
            ...
            sample_rate_hertz=AUDIO_SAMPLE_RATE_HZ,  # Ensure AUDIO_SAMPLE_RATE_HZ is defined somewhere
    ...
    def recognize(self, language_code='en-US', hint_phrases=None):
        ...
        with Recorder() as recorder:
            chunks = recorder.record(AudioFormat.CD,
                                     chunk_duration_sec=0.1,
                                     on_start=self.start_listening,
                                     on_stop=self.stop_listening)
                                     
            requests = (
                speech.StreamingRecognizeRequest(audio_content=data) for data in chunks
            )
