...
#48000
AudioFormat.CD = AudioFormat(sample_rate_hz=48000, num_channels=2, bytes_per_sample=2)
...
def arecord(fmt, filetype='raw', filename=None, device='hw:1,0'):
...
def aplay(fmt, filetype='raw', filename=None, device='hw:1,0'):
...
def record_file_async(fmt, filename, filetype, device='hw:1,0'):
    """
...
def record_file(fmt, filename, filetype, wait, device='hw:1,0'):
    """
...
class Recorder:
    ...
    def record(self, fmt, chunk_duration_sec, device='hw:1,0',
               num_chunks=None,
...
class FilePlayer(Player):
    ...
    """
    def play_raw(self, fmt, filename, device='hw:1,0'):
        """
    ...
    def play_wav(self, filename, device='hw:1,0'):
        """
        Plays a WAV file.
...
class BytesPlayer(Player):
    ...
    """
    def play(self, fmt, device='hw:1,0'):
        """
        Args:
            fmt: The audio format; an instance of :class:`AudioFormat`.
            device: The PCM device name. Leave as ``default`` to use the default ALSA soundcard.
